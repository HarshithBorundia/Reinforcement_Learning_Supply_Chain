...
add_reinforce_4 = True # RBF with 2 hidden layerst
add_dqn=False
...
add_reinforce_4 and add_graph_to_show("reinforce_phi4", "REINFORCE - Laplace")
add_dqn and add_graph_to_show("dqn", "DQN")
